...
from app.dtos.analysis import AnalysisSummaryResponse, RiskBrief, ScorecardResponse
from app.dtos.dashboard import RiskDetailResponse
from app.models.assessments import RiskAssessment
from app.models.enums import PeriodType
from app.models.health import DailyHealthLog, HealthProfile, PeriodicMeasurement
from app.services.prediction import calculate_findrisc
...
class RiskAnalysisService:
    ...
    async def recalculate_risk(self, user_id: int) -> RiskDetailResponse | None:
        ...
        from app.services.onboarding import AGE_RANGE_TO_NUMERIC
