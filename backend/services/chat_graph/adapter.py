...
async def _run_legacy_prep(inputs: ChatPrepInputs) -> ChatPrepOutput:
    ...
    build_result = _build_openai_messages_from_base_prompt(
        ...
        app_help_text=inputs.app_help_text,
        app_state_text=inputs.app_state_text,
        route=inputs.route,
    ...
    return ChatPrepOutput(
        ...
        app_help_layer=build_result.app_help_layer,
        app_state_layer=build_result.app_state_layer,
...
async def _run_graph_prep(inputs: ChatPrepInputs) -> ChatPrepOutput:
    ...
    return ChatPrepOutput(
        ...
        app_help_layer=result.get("app_help_layer", ""),
        app_state_layer=result.get("app_state_layer", ""),
...
def _parity_fields(output: ChatPrepOutput, *, route, emotional_priority, prompt_policy) -> dict[str, object]:
    return {
        ...
        "app_help_layer_sha256": _sha256_text(output.app_help_layer),
        "app_state_layer_sha256": _sha256_text(output.app_state_layer),
