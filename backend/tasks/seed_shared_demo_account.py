...
CHALLENGE_TEMPLATES = [
    ...
    },
    {
        ...
        "emoji": "",
        "category": ChallengeCategory.EXERCISE,
        "description": "아침·저녁 스트레칭으로 혈액순환을 돕고 유연성을 높여요.",
        "goal_criteria": {"field": "exercise_done", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "간단한 스트레칭도 혈당 조절과 스트레스 완화에 도움이 됩니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        "code": "no_phone_before_sleep",
        "name": "취침 전 스마트폰 금지",
        "emoji": "",
        "category": ChallengeCategory.SLEEP,
        "description": "잠들기 1시간 전에는 스마트폰을 내려놓아요.",
        "goal_criteria": {"field": "manual", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "블루라이트 차단으로 멜라토닌 분비를 돕고 수면 질을 향상시킵니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        "code": "consistent_bedtime",
        "name": "규칙적 취침 시간",
        "emoji": "",
        "category": ChallengeCategory.SLEEP,
        "description": "매일 같은 시간에 자고 일어나요.",
        "goal_criteria": {"field": "manual", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "수면 리듬 유지는 혈당 조절 호르몬 균형에 필수적입니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        "code": "water_before_meal",
        "name": "식전 물 한 잔",
        "emoji": "",
        "category": ChallengeCategory.HYDRATION,
        "description": "식사 30분 전에 물 한 잔(200ml)을 마셔요.",
        "goal_criteria": {"field": "water_cups", "daily_target": 1},
        "default_duration_days": 14,
        "evidence_summary": "식전 수분 섭취는 과식 예방과 소화 개선에 효과적입니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        "code": "herbal_tea_daily",
        "name": "무가당 차 마시기",
        "emoji": "",
        "category": ChallengeCategory.HYDRATION,
        "description": "하루 한 잔, 무가당 녹차 또는 허브티를 마셔요.",
        "goal_criteria": {"field": "manual", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "무가당 차는 항산화 작용과 혈당 안정화에 도움이 됩니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        ...
        "goal_criteria": {"field": "manual", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "식이섬유 풍부한 채소는 혈당 급등을 억제하고 장 건강을 개선합니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        "code": "no_sweetdrink",
        ...
        "emoji": "",
        "category": ChallengeCategory.DIET,
        "description": "탄산음료·과일 주스 등 당류 음료를 마시지 않아요.",
        "goal_criteria": {"field": "manual", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "설탕 음료 제한은 혈당 조절과 체중 관리에 가장 효과적인 식습관입니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        "code": "no_nightsnack",
        ...
        "emoji": "",
        "category": ChallengeCategory.DIET,
        "description": "저녁 9시 이후에는 음식을 먹지 않아요.",
        "goal_criteria": {"field": "manual", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "야간 공복 유지는 인슐린 저항성 감소와 지방 분해에 도움이 됩니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        "code": "drink_less_alcohol",
        "name": "음주 줄이기",
        "emoji": "",
        ...
        "goal_criteria": {"field": "manual", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "과음은 혈당 조절을 방해하고 간 건강에 부정적 영향을 줍니다.",
        "for_groups": ["A", "B", "C"],
    },
    {
        ...
        "description": "처방받은 약을 매일 빠짐없이 복용해요.",
        "goal_criteria": {"field": "manual", "daily_target": True},
        "default_duration_days": 14,
        "evidence_summary": "규칙적인 복약은 혈당 안정화의 기본입니다.",
        "for_groups": ["A", "B", "C"],
    },
]
