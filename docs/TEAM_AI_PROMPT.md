...
| challenge | GET | /api/v1/challenges/overview | 챌린지 목록 |
| challenge | POST | /api/v1/challenges/{id}/join | 챌린지 참여 |
| challenge | POST | /api/v1/challenges/{id}/checkin | 챌린지 체크인 |
| challenge | GET | /api/v1/challenges/{id}/calendar | 챌린지 캘린더 |
...
| API 스펙 확인 | `docs/collaboration/` 내 최신 확정 문서 |
| DB 구조 확인 | `docs/collaboration/` 내 최신 확정 문서 |
