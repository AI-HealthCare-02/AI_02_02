...
const CATEGORY_META = {
  sleep:     { label: '수면',   icon: Moon,            color: '#6366f1', bg: 'bg-indigo-50',  text: 'text-indigo-500',  bar: 'bg-indigo-400',  goal: '7h'    },
  diet:      { label: '식습관', icon: UtensilsCrossed, color: '#f59e0b', bg: 'bg-amber-50',   text: 'text-amber-500',   bar: 'bg-amber-400',   goal: '70점'  },
  exercise:  { label: '운동',   icon: Activity,        color: '#10b981', bg: 'bg-emerald-50', text: 'text-emerald-500', bar: 'bg-emerald-400', goal: '주 3회' },
  hydration: { label: '수분',   icon: Droplets,        color: '#3b82f6', bg: 'bg-blue-50',    text: 'text-blue-500',    bar: 'bg-blue-400',    goal: '1.2L'  },
};
