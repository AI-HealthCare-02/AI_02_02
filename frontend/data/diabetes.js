...
const diabetesQuestions = [
...

  {
    ...
    groups: [
      ...
      },
      {
        ...
        label: '연령대',
        options: [
          { value: 'under_45', label: '44세 이하' },
          { value: '45_54',    label: '45~54세' },
          { value: '55_64',    label: '55~64세' },
          { value: '65_plus',  label: '65세 이상' },
        ],
      },
    ],
  },
...

  {
    ...
    options: [
      ...
      { value: 'high_glucose',     label: '고혈당 판정 이력',      emoji: '📋' },
...

  {
    ...
    options: [
      ...
      { value: 'oral_med',   label: '경구 혈당강하제',       emoji: '💊' },
      { value: 'insulin',    label: '인슐린 주사',           emoji: '💉' },
      { value: 'other_med',  label: '기타 약물',             emoji: '🏥' },
    ...
    groups: [
      {
        ...
        label: '당화혈색소 (HbA1c)',
        options: [
          { value: 'under_5_7',    label: '~5.7%'   },
          { value: '5_7_to_6_4',  label: '5.7~6.4%' },
          { value: '6_5_to_7_0',  label: '6.5~7%'   },
      ...
      },
      {
        ...
        options: [
          ...
          { value: '100_to_125',  label: '100~125' },
          { value: 'over_126',    label: '126+'  },
          { value: 'unknown',     label: '모름', isDefault: true },
        ],
      },
    ],
...

  {
    ...
    options: [
      ...
      { value: '1_2_per_week',    label: '주 1~2회',        emoji: '🚶' },
      { value: '3_4_per_week',    label: '주 3~4회',        emoji: '🏃' },
      { value: '5_plus_per_week', label: '주 5회 이상',     emoji: '💪' },
    ],
  },

  {
    ...
    showFor: null,
    options: [
      { value: 'carb_heavy',       label: '밥·빵·면 위주',      emoji: '🍚' },
      { value: 'sugary_drink',    label: '단 음료 자주',        emoji: '🥤' },
      { value: 'late_snack',      label: '야식 자주',           emoji: '🌙' },
      { value: 'veggies_daily',   label: '채소·과일 매일',      emoji: '🥗' },
      { value: 'irregular_meals', label: '불규칙한 식사',       emoji: '⏰' },
...

  {
    ...
    showFor: null,
    options: [
      { value: 'risk_assessment',   label: '당뇨 위험도 알아보기',  emoji: '🎯' },
      { value: 'health_tracking',  label: '건강수치 추적하기',      emoji: '📊' },
      { value: 'diet_improvement', label: '식단 개선하기',          emoji: '🥗' },
      { value: 'exercise_habit',   label: '운동 습관 만들기',       emoji: '🏃' },
      { value: 'weight_management',label: '체중 관리하기',          emoji: '⚖️' },
...

  {
    ...
    showFor: null,
    options: [
      { value: 'agreed',   label: '네, 좋아요',       emoji: '👍' },
      { value: 'declined', label: '아니요, 괜찮아요',  emoji: '🚫' },
    ],
  },
